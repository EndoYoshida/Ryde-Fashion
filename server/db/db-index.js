...
// Split-out address parts + phone country code, so the profile form and
// the checkout form can share the exact same fields instead of one
// customer just having a single free-text `address` string to parse.
addColumnIfMissing("customers", "address_line", "TEXT");
addColumnIfMissing("customers", "barangay", "TEXT");
addColumnIfMissing("customers", "city", "TEXT");
addColumnIfMissing("customers", "province", "TEXT");
